...
namespace Assets.Scripts
{
    ...
    public class Ball : MonoBehaviour
    {
        ...
        public CountableSurfacesContactEvent onCountableSurfacesContactEvent = new CountableSurfacesContactEvent();
        ...
        private void OnCollisionEnter2D(Collision2D other)
        {
            ...
            if (countable != null)
            {
                onCountableSurfacesContactEvent.Invoke(countable.AmountOfPoints);
            }
        }
